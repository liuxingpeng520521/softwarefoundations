...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = m ->
     (n + p) = (minustwo o).
Proof. intros. apply trans_eq with (m:=m). apply H0. apply H. Qed.
...
Example injection_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  j = z :: l ->
  x = y.
Proof. intros X x y z l j. intros H H0. rewrite H0 in H.
  injection H as H1 H2. rewrite H1. rewrite H2. reflexivity. Qed.
...
Proof.
  ...
  -intros m H. destruct m.
    +discriminate.
    +apply f_equal. apply IHn'. simpl in H. injection H as H. rewrite <- plus_n_Sm in H.
...
Theorem nth_error_after_last: forall (n : nat) (X : Type) (l : list X),
  ...
  nth_error l n = None.
Proof.
  intros n X l H. generalize dependent l. induction n.
  -intros. destruct l.
    +simpl. reflexivity.
    +discriminate.
  -intros. destruct l.
    +simpl. reflexivity.
    +simpl. apply IHn. simpl in H. injection H as H. apply H.
Qed.  
...
Proof.
  ...
  -intros. injection H as H0 H1. rewrite<-H0. rewrite<- H1. simpl. reflexivity.
  -intros. destruct x. simpl in H.
   destruct (split l) as [t1 t2] eqn:E. injection H as H0 H1. rewrite<-H0. rewrite<-H1. simpl. 
...
Proof.
  ...
  - destruct (f false) eqn:H2.
    + destruct b.
      ...
      * rewrite -> H2. rewrite -> H1. apply H1.
    + destruct b.
      * rewrite -> H1. rewrite -> H1. apply H1.
      * rewrite -> H2. rewrite -> H2. apply H2.
  - destruct (f false) eqn:H2.
    + destruct b.
      * rewrite -> H1. rewrite -> H2. apply H1.
      * rewrite -> H2. rewrite -> H1. apply H2.
    + destruct b.
      * rewrite -> H1. rewrite -> H2. apply H2.
      * rewrite -> H2. rewrite -> H2. apply H2.
Qed.
...
Proof.
  ...
  destruct (n=?m) eqn:E1.
  -destruct (m=?p) eqn:E2.
   +apply eqb_true in E1. apply eqb_true in E2. rewrite->E1. rewrite->E2.  rewrite eqb_refl. reflexivity.
   +discriminate M.
  -discriminate H.
Qed.
...
Proof.
  ...
  - intros l1 l2 H1 H2. destruct l1. 
    ...
    + destruct l2.
      * discriminate H1.
      * discriminate H2.
  - intros lt1 lt2 H1 H2. destruct lt1 as [| l1h l1t].
    + discriminate H2. 
    + destruct lt2 as [| l2h l2t].
      * discriminate H1.
      * destruct h as [h1 h2]. 
        assert (eq: split t = (l1t, l2t)).
        { apply IHt.
           {simpl in H1. injection H1 as goal. apply goal. }
           {injection H2 as e1 e2 e3. apply e3. }
        }
        simpl. rewrite eq. injection H2 as e1 e2 e3. rewrite e1; rewrite e2. reflexivity.
Qed.
...
Proof.
  ...
  -intros lf H. simpl in H. 
   destruct (test t) eqn:E.
   +injection H as H0 H1. rewrite<- H0. apply E.
...
Definition existsb' {X : Type} (test : X -> bool) (l : list X) : bool:=
  negb (forallb (fun l => negb (test l)) l).
Theorem existsb_existsb' : forall (X : Type) (test : X -> bool) (l : list X),
  ...
  Proof.
    ...
    induction l as [|t l' IHl'].
    -simpl. reflexivity.
    -simpl. unfold existsb'. simpl. destruct (test t) eqn:E.
     +simpl. reflexivity.
