...
Proof.
  ...
  +inversion H. destruct (split l1') as [l1'' l2''] eqn:E. injection H1 as Hl Hr;subst.
   Search Permutation. change ((x1 :: l1'') ++ x2 :: l2'') with (x1 :: l1'' ++ x2 :: l2'').
   constructor. apply Permutation_trans with (x2 :: l1'' ++  l2'').
   -constructor. apply IHl'. reflexivity.
...
Proof.
  intros. simpl in *. bdestruct (x1 <=? x2).
  - constructor. lia. apply H1.
  - constructor. lia. apply H1.
Qed.
(** [] *)
  ...
  +induction l2;intros.
    ...
    *destruct l1 eqn:El1.
     ...
     **apply sorted_merge1.
     ...
     apply IHl1. inversion H; subst. apply H6. apply H0.
    *destruct l2 eqn:El1.
     **constructor. lia. assumption.
     **apply sorted_merge1. lia. 
       ++inversion H0;auto.
       ++apply IHl2. inversion H0; auto. 
Qed.
