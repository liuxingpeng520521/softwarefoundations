...
(* {k:A->A,j:B->B} <: {j:B->B} *)
Proof with eauto.
   unfold TRcd_kj, TRcd_j. eapply S_Trans.
   +apply S_RcdPerm... destruct(String.eqb k j) eqn:E.
    -apply eqb_eq in E. inversion E.
    -apply eqb_neq in E... 
  + apply S_RcdDepth...
Qed.
...
Example subtyping_example_2 :
  <{{ Top -> TRcd_kj }}> <:
          <{{ (C -> C) -> TRcd_j }}>.
Proof with eauto.
apply S_Arrow... apply subtyping_example_1. Qed.
(** [] *)
...
Example subtyping_example_4 :
  ...
  <{{ z : C :: y : B :: x : A :: nil }}>.
Proof with eauto.
  eapply S_Trans with  <{{y : B :: x : A :: z : C :: nil }}>.
  +apply S_RcdPerm... destruct(String.eqb x y) eqn:E.
  -apply eqb_eq in E. inversion E.
  -apply eqb_neq in E... 
  +eapply S_Trans with  <{{y : B :: z : C:: x : A  :: nil }}>.
   -apply S_RcdDepth... apply S_RcdPerm... destruct(String.eqb x z) eqn:E.
   *apply eqb_eq in E. inversion E.
   *apply eqb_neq in E...
   -apply S_RcdPerm... destruct(String.eqb y z) eqn:E.
   *apply eqb_eq in E. inversion E.
   *apply eqb_neq in E...
Qed.
(** [] *)
...
Proof with eauto.
  ...
  +exists V1,V2.  inversion H;subst...
...
Proof with eauto.
    unfold trcd_kj,TRcd_kj, TRcd_j. apply T_RCons... Qed.
...
+eapply T_Abs... -unfold TRcd_j... - apply T_Proj with TRcd_j... apply T_Var... unfold TRcd_j...
+apply T_Sub with TRcd_kj. -apply typing_example_0. -apply subtyping_example_1.
Qed.
...
Proof with eauto.
  ...
  +apply T_Abs... -unfold TRcd_j... -apply T_Proj with TRcd_j... apply T_App with <{{ (C -> C)}}>... ++ apply T_Var... unfold TRcd_j... 
  +apply T_Abs. ++unfold TRcd_j... ++apply T_Sub with TRcd_kj. -unfold trcd_kj,TRcd_kj,TRcd_j... apply T_RCons... -apply subtyping_example_1. 
Qed. 
(** [] *)
...
Proof with eauto.
    ...
    +rewrite HeqT in H1. apply sub_inversion_arrow in H1.
    destruct H1 as [V1 [V2 [H6 [H7 H8]]]]... rewrite H4. eapply IHhas_type...
Qed.
