...
Lemma t_update_eq : forall A (m: total_map A) x v,
  (t_update m x v) x = v.
Proof.
  intros. unfold t_update. rewrite Nat.eqb_refl. reflexivity. Qed. 
...
Proof.
  intros. unfold t_update. rewrite <-Nat.eqb_neq in H. rewrite H. reflexivity. Qed. 
(** [] *)
